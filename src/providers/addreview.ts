...
export class Addreview {
  ...
  constructor(public http: Http) {
    ...
    return this.http.post('https://ec2-54-201-208-89.us-west-2.compute.amazonaws.com:1443/api/review/getreviews', user)
  ...
  addReview(review) {
    ...
    return this.http.post('https://ec2-54-201-208-89.us-west-2.compute.amazonaws.com:1443/api/review/addreview', body, {
      headers: headers
    })
      .map((data: Response) => data.json())
  }
